...
const TechSlots: React.FC<TechSlotsProps> = ({ items, spinLabel, spinningLabel }) => {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-white/70 bg-gradient-to-br from-white via-white/80 to-neutral-50/70 p-4 sm:p-5 md:p-6 backdrop-blur-xl shadow-[0_18px_45px_rgba(15,23,42,0.08)]">
      <div
      ...
      <div className="relative z-10 space-y-4">
                  ...
                  <div
                    ...
                    style={{
                      ...
                      transition: isSpinning
                        ? `transform ${SPIN_DURATION}ms cubic-bezier(0.24,0.82,0.28,1)`
                        : 'transform 0ms'
                    }}
                  >
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 text-[11px] text-neutral-600">
          <span className="flex items-center gap-2">
            ...
            <span className="uppercase tracking-[0.12em]">Curated stack</span>
          </span>
          <span className="text-[#E65A4F] font-semibold uppercase tracking-[0.14em]">
            {isJackpot ? 'Triple match unlocked' : 'Smooth motion, no slips'}
          </span>
        </div>
      </div>
    </div>
